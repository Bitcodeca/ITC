...
require_once '/home2/paginasw/public_html/itcgroupca.com.ve/wp-content/themes/itc/phpmailer/PHPMailerAutoload.php';
...
if (isset($_POST['nombre']) && isset($_POST['email']) && isset($_POST['message'])) {
    ...
    $mail->AddAddress('itcgroupca@gmail.com');
    $mail->Subject = 'Contacto itcgroupca.com.ve';
